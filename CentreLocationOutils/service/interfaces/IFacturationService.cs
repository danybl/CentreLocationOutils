...
namespace CentreLocationOutils.service.interfaces
{
    ...
    public interface IFacturationService : IService
    {
        ...
        public virtual void add(Connection connection, FacturationDTO facturationDTO);
        ...
        public virtual FacturationDTO get(Connection connection, string idFacturation);
        ...
        public virtual void update(Connection connection, FacturationDTO facturationDTO);
        ...
        public virtual List<FacturationDTO> getall(Connection connection, string sortByPropertyName);
