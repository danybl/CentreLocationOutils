...
namespace CentreLocationOutils.service.interfaces
{
    ...
    public interface ILocationService : IService
    {
        ...
        public virtual void add(Connection connection, LocationDTO locationDTO);
        ...
        /// <param name="connection">La connexion à utiliser</param>
        /// <param name="locationDTO">La location à ajouter</param>
        public virtual void get(Connection connection, string idLocation);
        ...
        /// <param name="connection">La connexion à utiliser</param>
        /// <param name="locationDTO">La location à ajouter</param>
        public virtual void update(Connection connection, LocationDTO locationDTO);
        ...
        /// <param name="connection">La connexion à utiliser</param>
        /// <param name="locationDTO">La location à ajouter</param>
        public virtual void delete(Connection connection, LocationDTO locationDTO);
        ...
        public virtual List<LocationDTO> getAllLocations(Connection connection, string sortByPropertyName);
