...
namespace CentreLocationOutils.dao.interfaces
{
    public interface IClientDAO : IDAO
    {
        ...
        public virtual ClientDTO get(Connection connection,
            string primaryKey);
        ...
        public virtual List<ClientDTO> getAll(Connection connection,
        ...
        public virtual List<ClientDTO> findByNom(Connection connection,
            String nom,
            String sortByPropertyName);
